...
def get_pngs(name):
    ...
    command = "ffmpeg -i gfycat_testing/"+name+".webm -r 1 -filter:v \"crop=in_w/3:in_h/3:0:in_h\" -pix_fmt gray gfycat_testing/"+name+"/%03d-L.png" #Left
    os.system(command)
    command = "ffmpeg -i gfycat_testing/"+name+".webm -r 1 -filter:v \"crop=in_w/3:in_h/3:in_w/3:in_h\" -pix_fmt gray gfycat_testing/"+name+"/%03d-M.png" #Left
    os.system(command)
    command = "ffmpeg -i gfycat_testing/"+name+".webm -r 1 -filter:v \"crop=in_w/3:in_h/3:in_w*2/3:in_h\" -pix_fmt gray gfycat_testing/"+name+"/%03d-R.png" #Left
    os.system(command)
